  ...
  <div>
    ...
    <div class="drop" @drop="handleDrop" @dragover="handleDragover" @dragenter="handleDragover">
      <div class="" style="margin-top: -30px">
        <span>Thả tập excel vào đây hoặc</span>
        <el-button :loading="loading" style="margin-left:16px;" size="mini" type="primary" @click="handleUpload">Chọn tệp</el-button>
      </div>
    </div>
  </div>
</template>
